...
get_ipython().system('pip install torch==2.0.1+cu118 torchaudio==2.0.2 --index-url https://download.pytorch.org/whl/cu118')
# Step 2: NumPy
pip install numpy==1.26.4 --force-reinstall --no-cache-dir
get_ipython().system('pip install scipy scikit-learn sacremoses')
# Step 4: OpenCV and SceneDetect
get_ipython().system('pip install opencv-python==4.7.0.72 opencv-contrib-python==4.7.0.72 scenedetect==0.6.6')
# Step 5: Install sentence-transformers (frozen) without breaking NumPy
get_ipython().system('pip install transformers==4.40.1 sentence-transformers  tokenizers sacremoses')
get_ipython().system('pip install scipy==1.9.3 scikit-learn==1.1.3')
# Step 6: Utilities BLIP-2 support
get_ipython().system('pip install librosa==0.10.0.post2 Pillow accelerate bitsandbytes')
